export const menuItems = [
  {
    ...
    icon: (
      <img
        width="40"
        height=""
        src={require("assets/svg-icons/ODF.png")}
        alt="garbage-truck"
      />
    ),
  },
  ...
  },
  {
    ...
    icon: (
      <img
        width="40"
        height="40"
        src={require("assets/svg-icons/7583355.png")}
        alt="in-progress"
      />
    ),
  },
  ...
  },
  {
    ...
    icon: (
      <img
        width="40"
        height="40"
        src={require("assets/svg-icons/fund.png")}
        alt="cash"
      />
    ),
  },

  {
    ...
    icon: (
      <img
        width="40"
        height="40"
        src={require("assets/svg-icons/update.png")}
        alt="cash"
      />
    ),
  },
